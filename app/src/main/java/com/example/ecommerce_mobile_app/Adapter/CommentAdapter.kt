...
class CommentAdapter(private val commentsList: List<Comments>) : RecyclerView.Adapter<CommentAdapter.CommentViewHolder>() {
    ...
    override fun onBindViewHolder(holder: CommentViewHolder, position: Int) {
        ...
        holder.editCommentIcon.setOnClickListener {
            // Handle edit comment logic if required
        }
    }
